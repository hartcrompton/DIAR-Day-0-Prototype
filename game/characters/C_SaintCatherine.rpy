...
label .beat1:
    ...
    st "Part of me feels powerful. High-born, persuasive, willing to die for my faith."
    ...
    menu:
        "You're two people at once?":
            st "I remember both selves, but I'm not sure which one is real: the great saint, or the mortal woman?"
    ...
    menu:
        ...
        "We've gotta fix the glass by the opening.":
    ...
    menu:
        ...
        "Breaks in your memory, like amnesia?":
            st "Prayers have always told me who I am. Without hearing them, I can't make sense of the fragments."
...
label .beat2:
    ...
    st "Will you talk with me awhile? I think it will help me understand myself."
    menu:
        "Uh, like a pastor?":
            pass
    ...
    menu:
        ...
        "Unbothered and happy, with lots of freedom.":
            $ SaintPersonality = 1
            $ SaintHuman += 1
            st "{i}Ouais?{/i} I agree. With your background as a [pc_work], you're perfect for this."
    ...
    menu:
        ...
        "I shall endeavor to address you properly, O Saint.":
            if SaintSaintly > SaintHuman:
                ...
                st "{i}Zut alors{/i}, please don't, that's not necessary. We're both supporting the museum's guests, that's all."
    ...
    menu:
        ...
        "Why did you ask me those questions?":
            st "It's my purpose to shine light. I can do that best if we understand each other. Cast your eyes upon the glass…"
...
label .beat3:
    ...
    if SaintHuman > SaintSaintly:
        st "This is a lot, I know. You're doing great."
    else:
        st "Your patience does you credit."
...
label .beat4:
    ...
    st "Perhaps…but those who need me might benefit from the light cast by more traditional repairs."
    ...
    menu:
        "Yes, nothing has changed.":
            st "Thank you. Your certainty is reassuring."
            pass
        "No, I was wrong.":
...
label .Outcome:
    if beat_SaintCatherine == 5:
        if SaintHuman > SaintSaintly:
            if st_glass == 0:
                scene saint end pbr
                st "Catherine is a welcoming presence emphasizing the evolving story of art…"
                st "…including those who protected, restored, and changed the work in the intervening centuries."
            if st_glass == 1:
                scene saint end gbr
                st "Catherine shines down with kindness, evoking the time and place of its manufacture rather than the grand ideals it represents."
