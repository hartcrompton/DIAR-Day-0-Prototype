...
label minigamestart_cleaning(gameimage="notdefault"):
    python:
        diff_items = []
        diff_items.append(STD_Item("images/minigame/cleaning/cleaning_overlay_ph.jpg", 182,5,316,406))
        diff_items.append(STD_Item("images/minigame/cleaning/cleaning_overlay_ph.jpg", 154,888,124,72))
        diff_items.append(STD_Item("images/minigame/cleaning/cleaning_overlay_ph.jpg", 498,775,121,107))
        diff_items.append(STD_Item("images/minigame/cleaning/cleaning_overlay_ph.jpg", 726,976,128,96))
        diff_items.append(STD_Item("images/minigame/cleaning/cleaning_overlay_ph.jpg", 1233,887,133,70))
        diff_items.append(STD_Item("images/minigame/cleaning/cleaning_overlay_ph.jpg", 1670,954,188,121))
        diff_items.append(STD_Item("images/minigame/cleaning/cleaning_overlay_ph.jpg", 1188,618,115,123))
        diff_items.append(STD_Item("images/minigame/cleaning/cleaning_overlay_ph.jpg", 493,618,118,58))
        diff_items.append(STD_Item("images/minigame/cleaning/cleaning_overlay_ph.jpg", 692,5,512,290))
        diff_items.append(STD_Item("images/minigame/cleaning/cleaning_overlay_ph.jpg", 1303,5,311,465))
        diff_items.append(STD_Item("images/minigame/cleaning/cleaning_overlay_ph.jpg", 1699,385,96,155))
    ...
    python:
        ...
        difference_image = MinigameCleaning("images/minigame/cleaning/cleaning_ph.jpg", diff_items)
